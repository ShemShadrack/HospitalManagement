...
public class AboutUs
{
	...
	AboutUs()
	{
        ...
        JLabel heading = new JLabel("KDF MILITARY HOSPITAL");
        ...
        JLabel heading1 = new JLabel("KDF MILITARY HOSPITAL");
        ...
        String text3 = "At Kdf Military Hospital, our staff, faculty, students, volunteers and supporters are dedicated to improving the lives of people and families affected by psychiatric illness. As the largest psychiatric affiliate of Harvard Medical School, Kdf has been meeting the needs of individuals and families with psychiatric illness since our founding in 1811. We are here to help you.";
